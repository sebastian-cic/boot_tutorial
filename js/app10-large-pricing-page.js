...
polimexSea.push(new PopRegion("Estonia", 5.25, "sea", 20.00, 4, 30, "6-8 weeks", "Polimex"));
...
$("#destinationCountrySelectList").change(function () {
	...
	if (selectedText === "Poland" || selectedText === "POLAND") {
		showEcoRadio();
	}
});
...
function populateTable() {
	...
	for (i = 0; i < listAllCountries.length; i += 1) {
		$('#testerTable').append("<h3 id='"  + listAllCountries[i].region.split(" ")[0] + "'>" + "Shipping To " + listAllCountries[i].region + "</h3>");
